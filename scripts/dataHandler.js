const handleData = function (url, callbackFunctionName, callbackErrorFunctionName = null, method = 'GET', body = null, authToken = null) {
  ...
  .then(function(responsebody) {
    if (responsebody) {
      ...
      console.info('>> responsebody was leeg maar code 200 dus ok');
      console.info(`>> Callbackfunctie ${callbackFunctionName.name}("success") wordt opgeroepen`);
      callbackFunctionName('success');
    }
  })
